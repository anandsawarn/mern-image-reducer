  ...
  return (
    <nav className="bg-gradient-to-r from-blue-500 to-purple-500 shadow-lg fixed w-full top-0 z-50 border-b border-gray-200">
      <div className="container mx-auto flex justify-between items-center px-6 py-4">
        ...
        {/* ✅ Logo */}
        <Link to="/" className="flex items-center text-red-500 font-semibold text-lg">
  <motion.div
    initial={{ opacity: 0, x: -50 }}
    animate={{ opacity: 1, x: 0 }}
    transition={{ duration: 0.5 }}
    className="flex items-center absolute left-0 ml-4" // Added absolute positioning and left margin
  >
    <img 
      src="https://raw.githubusercontent.com/ddavison/chrome-youtube-resizer/master/src/images/resizer-logo.png" 
      alt="logo" 
      className="h-9 w-20" // Removed m-3 to avoid extra spacing
    />
  </motion.div>
</Link>
